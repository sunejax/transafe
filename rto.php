...
<br>
<table>
    <tr><td><b>Name</b></td><td><b>Email</b></td><td><b>Emergency Contact</b></td><td><b>Result</b></td><td><b>License Plate</b></td>
    ...
    <? while ($row_users = $results->fetch_array(MYSQLI_ASSOC)) {
        ...
        echo "<tr><td>".($row_users['name'])."</td><td>".($row_users['email'])."</td><td>".($row_users['em_no'])."</td><td>";if($row_users['score']>3)echo "Pass"; else echo "Fail"; echo "</td><td>".($row_users['li_pl'])."</td>
...
<tr><td>".($rtorow[$key]['name'])."</td><td>".($rtorow[$key]['email'])."</td><td>".($rtorow[$key]['em_no'])."</td><td>".($rtorow[$key]['score'])."</td><td>".($rtorow[$key]['li_pl'])."</td><td>".($rtorow[$key]['doc_rc'])."</td><td>".($rtorow[$key]['doc_li'])."</td><td>".($rtorow[$key]['doc_aa'])."</td></tr>";
        ;}
    ?>
</table>
<script>
