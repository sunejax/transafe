...
<table>
   <? while ($row_users = $results->fetch_array(MYSQLI_ASSOC)) {
    ...
    echo "<tr><td>".($row_users['name'])."</td><td>".($row_users['email'])."</td><td>".($row_users['em_no'])."</td><td id='".($uid.'_rc')."'><a target='_blank' href=$rc><img src =$rc></a></td><td><a target='_blank' href='$li'><img src =$li></a></td><td><a target='_blank' href='$aa'><img src =$aa></a></td></tr>";
    ;}
    ?>
</table>
<script>
